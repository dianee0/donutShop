...
('raised-donut', 'Raised Donut', 'Light and airy raised donut.', 165, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/raised-glaze.jpg', 'Glaze, Maple, Sugar, Crumb', 1, 'donuts'),
...
('custard-filled-bar', 'Custard Filled Bar', 'Glazed bar filled with smooth custard.', 275, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/filled-bars.jpg', 'Chocolate, Maple', 1, 'donuts'),
('old-fashioned', 'Old Fashioned', 'Traditional cake donut with a crispy exterior.', 165, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/old-fashion-glaze.jpg', 'Plain, Glazed, Blueberry, Maple, Chocolate', 1, 'donuts'),
('buttermilk-bar', 'Buttermilk Bar', 'Classic buttermilk bar.', 200, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/buttermilk-glaze.jpg', 'Plain, Glazed, Maple, Chocolate', 1, 'donuts'),
('filled-donut', 'Filled Round Donut', 'Soft donut with delicious filling.', 250, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/filled-rounds.jpg', 'Jelly, Custard, Lemon', 1, 'donuts'),
('twist', 'Twist', 'Twisted donut with your choice of topping.', 200, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/twists.jpg', 'Maple, Chocolate, Sugar, Glaze', 1, 'donuts');

-- Seed Menu Items (Specials)
INSERT OR REPLACE INTO MenuItem (id, name, description, price, imageUrl, flavors, isActive, categoryId) VALUES 
('apple-fritter', 'Apple Fritter', 'Large fritter loaded with apples and cinnamon, glazed to perfection.', 275, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/apple-fritt.jpg', NULL, 1, 'specials'),
('cinnamon-roll', 'Cinnamon Roll', 'Warm, gooey cinnamon roll, glazed to perfection.', 275, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/cinn-roll.jpg', NULL, 1, 'specials'),
('bear-claw', 'Bear Claw', 'A claw shaped pastry filled with apples and cinnamon, glazed to perfection.', 275, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/bear-claw.jpg', NULL, 1, 'specials');

-- Seed Menu Items (Croissants)
INSERT OR REPLACE INTO MenuItem (id, name, description, price, imageUrl, flavors, isActive, categoryId) VALUES 
('plain-croissant', 'Plain Croissant', 'Flaky, buttery, and golden brown.', 275, NULL, NULL, 1, 'croissants'),
...
('breakfast-croissant', 'Breakfast Style Croissant', 'Loaded with ham, cheese, egg, and bacon.', 900, 'https://pub-ffdd5ec52fff447f810ad326ce7f5712.r2.dev/menu/croissant-CHEB.jpg', NULL, 1, 'croissants');
...
('website-launch', 'Website Last Updated', 'January 14, 2026', 'info', 1, NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
